...
namespace Domain.Helpers
{
    ...
    public class InvalidDataXmlException : Exception
    {
        public InvalidDataXmlException()
        {
        }
        
        public InvalidDataXmlException(string message)
            : base(message)
        {
        }

        public InvalidDataXmlException(string message, Exception inner)
            : base(message, inner)
        {
        }
    }
